 ...
 */
final class Version20230226211428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, class_name_id INT DEFAULT NULL, subject_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, sex VARCHAR(255) NOT NULL, dateofbirth DATE NOT NULL, phone INT NOT NULL, INDEX IDX_B723AF33B462FB2A (class_name_id), UNIQUE INDEX UNIQ_B723AF3323EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
