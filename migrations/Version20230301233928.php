 ...
 */
final class Version20230301233928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classes (id INT AUTO_INCREMENT NOT NULL, campus_name_id INT DEFAULT NULL, teacher_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_2ED7EC538EFCF5 (campus_name_id), INDEX IDX_2ED7EC541807E1D (teacher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
